package net.heavenus.plot.utils.item;
...
public class ItemBuilder {
    ...
    public ItemBuilder(String item) {
        ...
        try {
            ...
            for (int i = 2; i < split.length; i++) {
                ...
                if (opt.startsWith("skinvalue=") && skull != null) {
                    try {
                        ...
                        Main.getInstance().getLogger().log(Level.WARNING, "Unexpected error ocurred profile on skull: ", ex);
                    }
                }
            ...
            Main.getInstance().getLogger().log(Level.WARNING, "Cant deserializeItem() from \"" + item + "\"", ex);
    ...
    public ItemStack build(boolean glow) {
        ...
        ItemStack item = glow ? glow() : this.item;
        destroy();
        return item;
    }
    ...
    public ItemStack build() {
        ...
        ItemStack item = this.glow ? glow() : this.item;
        destroy();
        return item;
    }
    ...
    public ItemBuilder color(Color color) {
        if (this.meta != null && this.meta instanceof LeatherArmorMeta) {
    ...
    public ItemBuilder skinFromValue(String value) {
        ...
        Bukkit.getUnsafe().modifyItemStack(item, "{SkullOwner:{Id:\"" + hashAsId + "\",Properties:{textures:[{Value:\"" + value + "\"}]}}}");
        return this;
    }
